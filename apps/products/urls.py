...
urlpatterns = [
    ...
    path('categories/homepage-sections/reorder/', HomepageSectionsReorderView.as_view(), name='category-homepage-sections-reorder'),
    ...
    path('homepage-sections/', HomepageSectionListView.as_view(), name='homepage-section-list'),
